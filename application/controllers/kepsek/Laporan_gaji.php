...
class Laporan_gaji extends CI_Controller{
    ...
    public function index()
    {
        ...
        $this->load->view('kepsek/filterLaporanGaji',$data);
    ...
    public function cetakLaporanGaji()
    {
        ...
        data_kehadiran.kode_gaji, data_kehadiran.izin, data_kehadiran.sakit, data_kehadiran.alpha
        FROM data_pegawai
        ...
        $this->load->view('desain_kepsek/header',$data);
        $this->load->view('kepsek/cetakDataGaji',$data);
    }
}
