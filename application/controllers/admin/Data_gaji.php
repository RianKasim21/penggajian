      ...
      WHERE kode_gaji='$id'")->result();
        ...
        <table>
          ...
          <tr>
            ...
            <td>:</td>
            <td>".$this->input->post('honor_pendidik')."</td>
          </tr>
          <tr>
            <td>Honor Tenaga Kependidikan</td>
            <td>:</td>
            <td>".$this->input->post('honor_tk')."</td>
          </tr>
          <tr>
            <td>Tunjangan Jabatan</td>
            <td>:</td>
            <td>".$this->input->post('tj_jabatan')."</td>
          </tr>
          <tr>
            <td>Kepala Program Keahlian</td>
            <td>:</td>
            <td>".$this->input->post('kepala_program')."</td>
          </tr>
          <tr>
            <td>Eskul</td>
            <td>:</td>
            <td>".$this->input->post('eskul')."</td>
          </tr>
          <tr>
            <td>Piket Bulanan</td>
            <td>:</td>
            <td>".$this->input->post('ph_guru')."</td>
          </tr>
          <tr>
            <td>Alfa</td>
            <td>:</td>
            <td>".$this->input->post('alfa')."</td>
          </tr>
          <tr>
            <td>Sakit</td>
            <td>:</td>
            <td>".$this->input->post('sakit')."</td>
          </tr>
          <tr>
            <td>izin</td>
            <td>:</td>
            <td>".$this->input->post('izin')."</td>
          </tr>
          <tr>
            <td>Potongan</td>
            <td>:</td>
            <td>".$this->input->post('potongan')."</td>
          </tr>
          <tr>
            <td>Gaji</td>
            <td>:</td>
