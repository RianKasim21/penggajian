...
class potongan_gaji extends CI_Controller{
    ...
    public function index()
    {
        ...
        $this->load->view('staff/potongan_gaji',$data);
    ...
    public function tambah_data()
    {
        ...
        $this->load->view('desain_staffTU/header',$data);
        $this->load->view('desain_staffTU/sidebar');
        $this->load->view('staff/formPotonganGaji',$data);
        $this->load->view('desain_staffTU/footer');
    }
    ...
    public function update_data($id)
    {
        ...
        $this->load->view('desain_staffTU/header',$data);
        $this->load->view('desain_staffTU/sidebar');
        $this->load->view('staff/formUpdatePotonganGaji',$data);
        $this->load->view('desain_staffTU/footer');
    }
