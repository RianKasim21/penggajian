<div class="container-fluid">
    ...
    <form class="form-inline">
        ...
        <?php if(count($gaji) > 0) { ?>
            <a href="<?php echo base_url('staff/data_gaji/cetakGaji?bulan='.$bulan),'$tahun='.$tahun ?>" target="blank" class="btn btn-success mb-2 ml-2"><i class="fas fa-plus"></i> Cetak Daftar gaji</a>
            <?php }else{ ?>
        ...
        <div class="table-responsive">
            <table id="example" class="table table-striped table-bordered">
                ...
                <tr>
                    ...
                    ?>
                    <form method="POST" action="<?php echo base_url('staff/data_gaji/update_data_aksi/'.$g->kode_gaji) ?>" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="gaji" class="form-control" value="<?php echo $honor_pendidik + $g->honor_tk + $g->tj_jabatan + $g->kepala_program + $g->eskul + $g->ph_guru - $potongan - $potongan1 - $potongan2 - $g->potongan,0,',','.' ?>">
