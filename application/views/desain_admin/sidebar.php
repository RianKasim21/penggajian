		...
		<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
			...
			<li class="nav-item">
				...
				<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						<a class="collapse-item" href="<?php echo base_url('admin/data_guru') ?>">Data Pegawai</a>
			...
			<li class="nav-item">
				...
				<div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
					...
					<div class="bg-white py-2 collapse-inner rounded">
						<a class="collapse-item" href="<?php echo base_url('admin/data_absen') ?> ">Data Absen</a>
						<a class="collapse-item" href="<?php echo base_url('admin/data_mengajar') ?> ">Data Mengajar</a>
						<a class="collapse-item" href="<?php echo base_url('admin/data_potongan') ?> ">Data Potongan</a>
						<a class="collapse-item" href="<?php echo base_url('admin/potongan_gaji') ?> ">Setting Potongan
							Gaji</a>
						<a class="collapse-item" href="<?php echo base_url('admin/data_absensi') ?> ">Rekap Data Penggajian</a>
				...
				<div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						<a class="collapse-item" href="<?php echo base_url('admin/laporan_absensi') ?>">Laporan
							Absensi</a>
						<a class="collapse-item" href="<?php echo base_url('admin/laporan_potongan') ?>">Laporan Potongan</a>
