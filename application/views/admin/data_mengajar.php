<div class="container-fluid">
	...
	<div class="card mb-3">
        ...
        for($i = 1; $i <= $daysInMonth; $i++) { 
            $day = str_pad($i, 2, '0', STR_PAD_LEFT); // Pad single-digit days with a leading zero
            ?>
...
<div class="table-responsive">
		...
		<tr>
			...
			<td class="text-center" id="status-cell-<?php echo $a->id_mengajar; ?>">
				...
				<?php else: ?>
				<button class="btn btn-success" onclick="updateStatus('<?php echo $a->id_mengajar; ?>', 'Diterima')"><i
