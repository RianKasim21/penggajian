<div class="container-fluid">
    ...
    <div class="form-group mb-2 ml-1">
        ...
        <button type="submit" class="btn btn-primary mb-2 ml-auto"><i class="fas fa-eye"></i> Tampilkan Data Mengajar</button>
    </form>
        ...
        <table class="table table-bordered table-striped mt-2">
                ...
                <?php $no=1; foreach ($input_mengajar as $a) : ?>
                    <tr>
                        ...
                        <td><input type="number" name="jumlah_jam[]" class="form-control"></td>
                    </tr>
                <?php endforeach; ?>
        </table>
    </form>
