		...
		<div class="card-body">
			...
			<form class="form-inline">
				...
				<button type="submit" class="btn btn-primary mb-2 ml-auto"><i class="fas fa-eye"></i> Tampilkan
					Potongan</button>
				<a href="<?php echo base_url('admin/data_potongan/tambah_data') ?>" class="btn btn-success mb-2 ml-2"><i
			...
			<td>
				<center>
					<a class="btn btn-sm btn-primary"
						href="<?php echo base_url('admin/data_potongan/update_data/'.$a->id_potongan) ?>">
						<i class="fas fa-edit"></i></a>
					<a onclick="return confirm('Yakin Ingin Hapus ?')" class="btn btn-sm btn-danger"
						href="<?php echo base_url('admin/data_potongan/delete_data/'.$a->id_potongan) ?>">
